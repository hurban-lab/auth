...
public class ErrorDescription {
     ...
     *
     * @param application the name of the module.
     */
     ...
     */
    public static ErrorDescription buildError(String code, String module, Throwable throwable,
                                              HttpServletRequest request) {
        ErrorDescription dto = new ErrorDescription();
        dto.setCode(code);
        dto.setApplication(module);
        if (throwable != null) {
     ...
     * @return an ErrorDescription.
     */
    public static ErrorDescription buildError(String module, AuthError error,
                                              HttpServletRequest
                                                      request) {
        ErrorDescription description = new ErrorDescription();
        description.setCode(error.getErrorCode());
        description.setApplication(module);
